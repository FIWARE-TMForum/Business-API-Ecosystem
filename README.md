...
The following versions are generated automatically from the first entry in [`stack.yaml`](stack.yaml) (`stacks[0]`, id `2026.07.08`):

| Component | Stack key | Version |
|---|---|---|
| Web frontend | `front` | `2.21.4` |
| Business Ecosystem Logic Proxy | `proxy` | `11.21.4` |
