...
The following versions are generated automatically from the first entry in [`stack.yaml`](stack.yaml) (`stacks[0]`, id `2026.06.17`):

| Component | Stack key | Version |
|---|---|---|
| Web frontend | `front` | `2.20.5` |
| Business Ecosystem Logic Proxy | `proxy` | `11.20.4` |
| Business Ecosystem Charging Backend | `charging` | `11.7.0` |
