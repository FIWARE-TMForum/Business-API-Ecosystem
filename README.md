...
The following versions are generated automatically from the first entry in [`stack.yaml`](stack.yaml) (`stacks[0]`, id `2026.05.12`):

| Component | Stack key | Version |
|---|---|---|
| Web frontend | `front` | `2.19.1` |
| Business Ecosystem Logic Proxy | `proxy` | `11.19.1` |
